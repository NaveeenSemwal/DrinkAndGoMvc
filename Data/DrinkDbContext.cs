...
{
    public class DrinkDbContext : IdentityDbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Error : While creating Identity tables : - The entity type 'IdentityUserLogin<string>' requires a primary key to be defined.
            base.OnModelCreating(modelBuilder);

            modelBuilder.Entity<Category>().HasData(

                new Category { Id = 1, Name = "Alcoholic", Description = "All alcoholic drinks" },
                new Category { Id = 2, Name = "Non-alcoholic", Description = "All non-alcoholic drinks" }
